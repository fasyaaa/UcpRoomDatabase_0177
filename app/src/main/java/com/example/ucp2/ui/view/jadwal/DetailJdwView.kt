...
fun DetailJdwView(
    ...
    Scaffold( modifier = modifier,
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = { onEditClick(viewModel.detailUiState.value.detailUiEvent.idJdw.toString()) },
...
fun ItemDetailJdw(
    ...
    Card(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.padding(4.dp))
            ComponentDetailJdw(judul = "Nomer Telephone", isinya = jadwal.nohp)
            Spacer(modifier = Modifier.padding(4.dp))
            ComponentDetailJdw(judul = "Tanggal Konsultasi", isinya = jadwal.tglKon)
            Spacer(modifier = Modifier.padding(4.dp))
